    ...
    [
      _c(
        ...
        [
                                    ...
                                    _c(
                                      ...
                                      [
                                        _vm._v(
                                          "Categoria: " +
                                            _vm._s(
                                              _vm.explorarcategoria.categoria
                                            )
                                        )
                                      ]
                                    )
                                    ...
                                    _c(
                                      ...
                                      [
                                        _vm._v(
                                          "Departamento: " +
                                            _vm._s(
                                              _vm.verdepartamento.departamento
                                            )
                                        )
                                      ]
                                    )
                                  ...
                                  [
                                    _c(
                                      ...
                                      [
                                        _vm._v(
                                          "Categoria: " +
                                            _vm._s(_vm.vercategoria.categoria)
                                        )
                                      ]
                                    )
                                  ],
                            ...
                            _vm.verempleados.length > 0
                              ? _c(
                                  ...
                                  [
                                    _c(
                                      "v-row",
                                      _vm._l(_vm.verempleados, function(list) {
                                        return _c(
                                          "v-col",
                                          { key: list.id },
                                          [
          ...
          _vm._v(" "),
          _c("v-row", [
            _c("p", { attrs: { color: "red" } }, [
              _vm._v(
                "!No se podran Asignar equipos de otros departamentos, ni asignar equipos ya asignados"
              )
            ])
          ]),
          _vm._v(" "),
                    ...
                    _c(
                      ...
                      _vm._l(_vm.equipostable, function(equipo) {
                        return _c("tr", { key: equipo.id }, [
                          _c("td", [_vm._v(_vm._s(equipo.equipo))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(equipo.modelo))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(equipo.status))]),
                          _vm._v(" "),
                          _c("td", [_vm._v(_vm._s(equipo.codigo))]),
                          _vm._v(" "),
                          _c(
                            "td",
                            [
                              _c(
                                "v-btn",
                                {
                                  attrs: { icon: "", color: "teal darken-2" },
                                  on: {
                                    click: function($event) {
                                      return _vm.verequipo(equipo.id)
                                    }
                                  }
                                },
                            ...
                            [
                              _c(
                                "v-btn",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.asignarar(equipo.id)
                                    }
                                  }
                                },
                            ...
                            _c(
                              ...
                              [
                                _c("v-pagination", {
                                  staticClass: "my-4",
                                  attrs: {
                                    length: _vm.paginatetable.last_page
                                  },
                                  on: {
                                    input: function($event) {
                                      return _vm.Chagepage2(
                                        _vm.paginatetable.current_page
                                      )
                                    }
                                  },
                                  model: {
                                    value: _vm.paginatetable.current_page,
                                    callback: function($$v) {
                                      _vm.$set(
                                        _vm.paginatetable,
                                        "current_page",
                                    ...
                                    expression: "paginatetable.current_page"
                                  }
                                })
                              ],
                              1
